...
[Using Router and Lazy Loading](#serie5)   
[What is PWA	(progressive web app)](#serie6)  
[What is RxJS](#serie7)  
[What is GSAP	(ngx-gsap-draggable?)](#serie8)  
[Using Database](#serie9)  
[Angular Universal](#serie10)  
[Under the Hood – Webpack](#serie11)  
[Under the Hood – Typescript](#serie12)  
[Under the Hood – JavaScript (Object and Function)](#serie13)  
